...
const config = {
  // Base API URL - Points to existing desktop backend
  // In production, this should be your server URL (e.g., http://66.94.105.43:3000)
  ...
  endpoints: {
    ...
    timesheets: {
      ...
      submit: (id) => `/api/timesheets/${id}/submit`,
      approve: (id) => `/api/timesheets/${id}/approve`,
      reject: (id) => `/api/timesheets/${id}/reject`,
      generateInvoice: (id) => `/api/timesheets/${id}/generate-invoice`,
