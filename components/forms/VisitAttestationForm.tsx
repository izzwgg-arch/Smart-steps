        ...
        <div className="bg-white shadow rounded-lg p-6 print-form" style={{ boxShadow: 'none' }}>
          ...
          <div className="modern-form-header mb-8">
            <div className="header-gradient">
              <h1 className="text-3xl font-bold mb-2 text-white">VISIT ATTESTATION FORM</h1>
          ...
          <div className="mb-8">
            <div className="info-card">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <div className="info-label">Name (Client)</div>
                ...
                <div>
                  ...
                  <div className="print-only info-value">{selectedProvider ? selectedProvider.name : 'N/A'}</div>
                </div>
              </div>
            </div>
          </div>
                ...
                <table className="modern-table w-full">
                  <thead>
                    <tr>
                      ...
                      <th className="table-header">Parent Signature</th>
                    </tr>
                  </thead>
                  <tbody>
                    {rows
